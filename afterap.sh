...
uci set network.bat0_hardif_mesh0.mtu='1560'
uci set network.bat1_hardif_mesh0=interface
uci set network.bat1_hardif_mesh0.proto='batadv_hardif'
uci set network.bat1_hardif_mesh0.master='bat0'
uci set network.bat1_hardif_mesh0.mtu='1560'
