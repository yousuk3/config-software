...
uci set wireless.default_${RADIO_A}.encryption='psk2+ccmp'
uci set wireless.default_${RADIO_A}.ssid=${WIFI_SSID_A}
uci set wireless.default_${RADIO_A}.key=${WIFI_PASSWORD_A}
# uci set wireless.default_${RADIO_A}.multicast_to_unicast='1' # old setting
# uci set wireless.default_${RADIO_A}.isolate='1' # block access in same AP 
...
uci set wireless.default_${RADIO_A}.disassoc_low_ack='0' # maintain low ack
...
# uci set wireless.default_${RADIO_A}.ieee80211k='1'
# uci set wireless.default_${RADIO_A}.bss_transition='1'
# Wi-Fi AA channels
RADIO_AA='radio'
...
uci set wireless.default_${RADIO_AA}.encryption='psk2+ccmp'
uci set wireless.default_${RADIO_AA}.ssid=${WIFI_SSID_AA}
uci set wireless.default_${RADIO_AA}.key=${WIFI_PASSWORD_AA}
# uci set wireless.default_${RADIO_AA}.multicast_to_unicast='1' # old setting
# uci set wireless.default_${RADIO_AA}.isolate='1'	# block access in same AP
...
uci set wireless.default_${RADIO_AA}.disassoc_low_ack='0' # maintain low ack
...
# uci set wireless.default_${RADIO_AA}.ieee80211k='1'
# uci set wireless.default_${RADIO_AA}.bss_transition='1'
# Wi-Fi B channel
RADIO_B='radio'
WIFI_SSID_B='SSID_B'
...
uci set wireless.default_${RADIO_B}.encryption='psk2+ccmp'
uci set wireless.default_${RADIO_B}.ssid=${WIFI_SSID_B}
uci set wireless.default_${RADIO_B}.key=${WIFI_PASSWORD_B}
# uci set wireless.default_${RADIO_B}.multicast_to_unicast='1' # old setting
# uci set wireless.default_${RADIO_B}.isolate='1' # block access in same AP
...
uci set wireless.default_${RADIO_B}.disassoc_low_ack='0' # maintain low ack
...
# uci set wireless.default_${RADIO_B}.ieee80211k='1'
# uci set wireless.default_${RADIO_B}.bss_transition='1'
# Wi-Fi BB channel
RADIO_BB='radio'
...
uci set wireless.default_${RADIO_BB}.encryption='psk2+ccmp'
uci set wireless.default_${RADIO_BB}.ssid=${WIFI_SSID_BB}
uci set wireless.default_${RADIO_BB}.key=${WIFI_PASSWORD_BB}
# uci set wireless.default_${RADIO_BB}.multicast_to_unicast='1' # old seeting
# uci set wireless.default_${RADIO_BB}.isolate='1' # block access in same AP
...
uci set wireless.default_${RADIO_BB}.disassoc_low_ack='0' # maintain low ack
...
# uci set wireless.default_${RADIO_BB}.ieee80211k='1'
# uci set wireless.default_${RADIO_BB}.bss_transition='1'
# Wi-Fi C channel
RADIO_C='radio'
WIFI_SSID_C='SSID_C'
...
uci set wireless.default_${RADIO_C}.encryption='psk2+ccmp'
uci set wireless.default_${RADIO_C}.ssid=${WIFI_SSID_C}
uci set wireless.default_${RADIO_C}.key=${WIFI_PASSWORD_C}
# uci set wireless.default_${RADIO_C}.multicast_to_unicast='1' # old setting
# uci set wireless.default_${RADIO_C}.isolate='1' # block accesss in same AP
...
uci set wireless.default_${RADIO_C}.disassoc_low_ack='0' # maintain low ack
...
# uci set wireless.default_${RADIO_C}.ieee80211k='1'
# uci set wireless.default_${RADIO_C}.bss_transition='1'
# Wi-Fi CC channel
RADIO_CC='radio'
...
uci set wireless.default_${RADIO_CC}.encryption='psk2+ccmp'
uci set wireless.default_${RADIO_CC}.ssid=${WIFI_SSID_CC}
uci set wireless.default_${RADIO_CC}.key=${WIFI_PASSWORD_CC}
# uci set wireless.default_${RADIO_CC}.multicast_to_unicast='1' # old setting
# uci set wireless.default_${RADIO_CC}.isolate='1' # block accewss in same AP
...
# uci set wireless.default_${RADIO_C}.wpa_disable_eapol_key_retries='1'
uci set wireless.default_${RADIO_CC}.disassoc_low_ack='0' # maintain low ack
...
# uci set wireless.default_${RADIO_CC}.ieee80211k='1'
