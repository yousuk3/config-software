...
uci set wireless.default_${RADIO_A}.disassoc_low_ack='0'
...
uci set wireless.default_${RADIO_AA}.disassoc_low_ack='0'
...
uci set wireless.default_${RADIO_B}.disassoc_low_ack='0'
...
uci set wireless.default_${RADIO_BB}.disassoc_low_ack='0'
...
uci set wireless.default_${RADIO_C}.disassoc_low_ack='0'
...
uci set wireless.default_${RADIO_CC}.disassoc_low_ack='0'
